      ...
      child: SizedBox(
          ...
          child: ClipRRect(
            borderRadius: _isOpen
                ? BorderRadius.only(
                    topLeft: Radius.circular(style.radius ?? 9),
                    topRight: Radius.circular(style.radius ?? 9))
                : BorderRadius.circular(style.radius ?? 9),
            child: Material(
              ...
              Positioned(
                ...
                child: CompositedTransformFollower(
                  offset: widget.dropdownStyle.offset ??
                      Offset(
                          0,
                          widget.dropdownStyle.topOffset != null
                              ? (size.height + widget.dropdownStyle.topOffset!)
                              : size.height),
                  link: _layerLink,
                  showWhenUnlinked: false,
                  child: Material(
                    elevation: widget.dropdownStyle.elevation ?? 2,
                    borderRadius: _isOpen
                        ? BorderRadius.only(
                            bottomLeft: Radius.circular(
                                widget.dropdownStyle.radius ?? 9),
